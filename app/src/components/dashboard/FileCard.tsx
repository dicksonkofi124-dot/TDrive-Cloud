...
import { Folder, Eye, Trash2, Share2, Edit2 } from 'lucide-react';
            ...
            >
                ...
                <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1 z-10">
                    <button 
                        ...
                        className="file-action-btn p-1 bg-black/50 rounded-full hover:bg-telegram-primary hover:text-white text-white/70" 
                        title="Preview"
                    >
                    ...
                    {!isFolder && onShare && (
                        <button 
                            ...
                            className="file-action-btn p-1 bg-black/50 rounded-full hover:bg-blue-500 hover:text-white text-white/70" 
                    ...
                    {!isFolder && onRename && (
                        <button 
                            ...
                            className="file-action-btn p-1 bg-black/50 rounded-full hover:bg-amber-500 hover:text-white text-white/70" 
                            title="Rename"
                        >
                    ...
                    <button 
                        ...
                        className="file-action-btn p-1 bg-black/50 rounded-full hover:bg-green-500 hover:text-white text-white/70" 
                        title="Download"
                    >
                    ...
                    <button 
                        ...
                        className="file-action-btn p-1 bg-black/50 rounded-full hover:bg-red-500 hover:text-white text-white/70" 
                        title="Delete"
                    >
