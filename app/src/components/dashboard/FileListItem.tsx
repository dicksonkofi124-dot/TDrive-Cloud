...
import { Folder, Eye, HardDrive, Plus, Share2, Edit2 } from 'lucide-react';
...
export function FileListItem({
    ...
    onPreview, onDownload, onDelete, onShare, onRename
}: FileListItemProps) {
            ...
            <div className="truncate text-sm text-telegram-text font-medium relative pr-8">
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 flex items-center bg-telegram-surface border border-telegram-border shadow-lg rounded px-1">
                    <button 
                        ...
                        className="p-1 hover:text-telegram-text text-telegram-subtext" 
                        title="Preview"
                    >
                    ...
                    <button 
                        ...
                        className="p-1 hover:text-red-400 text-telegram-subtext" 
                        title="Delete"
                    >
